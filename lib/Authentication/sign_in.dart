      ...
      if (userEmailController.text == "" || passwordController.text == "") {
        showDialog(
          ...
          builder: (context) {
            return const MyDialog(
              text:
                  "There are no inputs either on Email or Password. Please Check carefully!",
              dialogSize: 162,
            );
          },
        );
        ...
        showDialog(
          ...
          builder: (context) {
            return const MyDialog(
              text:
                  "This account has not been created yet. Or misspelled. Please Check Carefully!",
              dialogSize: 162,
            );
          },
        );
        ...
        body: SingleChildScrollView(
          child: Center(
            child: Column(children: [
              ...
              const MyLogo(
                  image: 'assets/svg/log_inLogo.svg',
                  widthSize: 224,
                  heightSize: 167),
